...
function setup() {
    ...
    createP('');
    let vymen = createButton('â‡†');
    createP('Do soustavy:');
    dosous = createInput('2');
    createP('');
    bpocitej = createButton('PĹ™eveÄŹ');
...
function vypocitej(c, z, d) {
    if (d > 1 && z > 1) {
        ...
        alert('Error 3159743');
        alert('Co to na mÄ› zkouĹˇĂ­Ĺˇ? jedniÄŤkovĂˇ nebo nulovĂˇ soustava neexistuje.');
        alert('I kdyĹľ je pravda Ĺľe tu nÄ›jakĂ© ty chybiÄŤky v kodu budou.');
    }
    ci = 0;
}
